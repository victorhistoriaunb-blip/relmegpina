  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Perfis Parlamentares — RelMeg" },
      {
        ...
        content: "Consulte e gerencie os perfis parlamentares da sua base.",
      },
...
function Perfis() {
  ...
  const [view, setView] = useState<"cards" | "tabela">(prefs.visaoPadraoPerfis ?? "cards");
    ...
    <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3 sm:flex sm:items-end sm:justify-between">
      <div className="min-w-0">
        <h1 className="font-display text-xl font-semibold sm:text-2xl">
          {textos["perfisTitulo"] || "Perfis Parlamentares"}
        </h1>
        <p className="text-sm text-muted-foreground">
          {textos["perfisSubtitulo"] || "Consulte e gerencie os perfis parlamentares da sua base."}
        </p>
      </div>
